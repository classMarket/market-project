...
export default function BottomTab({navigation, route} : any) {
  return (
    <Tabs.Navigator>
      <Tabs.Screen name="홈" component={Home} options= {{
      ...
      <Tabs.Screen name="모임" component={Class} options= {{
          tabBarLabel: ({focused, color}) => {
            return (
      ...
      <Tabs.Screen name="등록" component={Post} options= {{
          tabBarLabel: ({focused, color}) => {
            return (
      ...
      <Tabs.Screen name="채팅" component={Chat} options= {{
          tabBarLabel: ({focused, color}) => {
            return (
      ...
      <Tabs.Screen name="프로필" component={Profile} options= {{
          tabBarLabel: ({focused, color}) => {
            return (
